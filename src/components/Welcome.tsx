  ...
  return (
    <>
      ...
      <p>
        ...
        each local community’s diasporic roots.The label is particularly focused
        on communities residing in the Bay Area connected to Louisiana, The
        American South, Africa, The Caribbean, and Latin America.Heirloom
        Records also focuses on re-release of source recordings from which local
        communities find their roots, and analyzing and exposing the living
        relationship between local communities and their source.
      </p>
    </>
  );
}
