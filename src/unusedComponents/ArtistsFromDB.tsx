...
//   const [selectedArtistElements, setSelectedArtistElements] = useState<
//     JSX.Element[]
//   >([]);
...
//         const filteredA_J = data.filter(
//           (artist) =>
//             artist.first_name[0].toUpperCase() >= 'A' &&
//             artist.first_name[0].toUpperCase() <= 'J'
//         );
//         const filteredK_Q = data.filter(
//           (artist) =>
//             artist.first_name[0].toUpperCase() >= 'K' &&
//             artist.first_name[0].toUpperCase() <= 'Q'
//         );
//         const filteredR_Z = data.filter(
//           (artist) =>
//             artist.first_name[0].toUpperCase() >= 'R' &&
//             artist.first_name[0].toUpperCase() <= 'Z'
//         );
...
//           {selectedCategory && (
//             <div className="artist-list">{selectedArtistElements}</div>
//           )}
//         </>
//       ) : (
//         <p>loading...</p>
